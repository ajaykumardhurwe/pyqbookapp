...
const questions = [
  {
    question: "Q.1 निम्नलिखित में से कौन-सा एक ऑपरेटिंग सिस्टम नहीं है?",
    options: ["एम एस विंडोज", "क्रोम", "विंडोज एन टी", "सोलरिस "],
    correctOptionIndex: 1,
    explanation: "Crome is Browser not crome"
  },
  {
    question: "Q.2 लिनक्स एक ऑपरेटिंग सिस्टम है।",
    options: ["ओपन सोर्स", "विंडोज", "मैक", "माइक्रोसॉफ्ट "],
    correctOptionIndex: 0,
    explanation: "Linux is basically used for hacking purpose so they available as open source"
  },
  {
    question: "Q.3 निम्न आप्टिकल मीडिया ग्रुप में से किसकी मेमोरी स्टोरिंग कैपेसिटी अधिकतम होती है ?",
    options: ["डी.बी.डी.-आर.डब्ल्यू.", "डी.बी.डी. आर.ओ.एम.", "ब्लू रे", "डी.बी.डी.-आर.ए.एम."],
  ...
  {
    question: "Q.4 निम्न में से रिमूवेबल मीडिया में आते हैं।",
    options: ["सी.डी.-आर.ओ.एम.", "डिस्केट", "डी.वी.डी.", "हार्ड डिस्क ड्राइव"],
  ...
  {
    question: "Q.5 CDs और DVDs किस प्रकार के यंत्र है ?",
    options: ["इनपुट", "आउटपुट", "स्टोरेज", "साफ्टवेयर"],
    correctOptionIndex: 2,
  ...
  {
    question: "Q.6 निम्नलिखित में से कौन-सा एक आउटपुट डिवाईस नहीं है ?",
    options: ["प्रिंटर", "स्कैनर", "मॉनिटर", "प्रोजेक्टर"],
    correctOptionIndex: 1,
    explanation: "स्कैनर एक ऐसा उपकरण है जिससे भौतिक दस्तावेज़ों, छवियों, या वस्तुओं को डिजिटल रूप में बदला जा सकता है."
  },
  {
    question: "Q.7 सी.पी.यू. का पूर्ण रूप है",
    options: ["सेंट्रल प्रोसेसिंग युनिट", "कंट्रोल प्रोसेसिंग युनिट", "सेंट्रल प्रोग्रामिंग युनिट", "कंट्रोल प्रोग्रामिंग युनिट"],
    correctOptionIndex: 0,
  ...
  {
    question: "Q. 9  पिक्चर (चित्र/तस्वीर) जिन छोटे डॉट्स से निर्मित होती है उसे कहते हैं………….।",
    options: ["इमेज", "पिक्सेल्स", "प्वाइन्टस", "उपरोक्त में कोई नहीं"],
    correctOptionIndex: 1,
  ...
  {
    question: "Q. 10 निम्नांकित में से किसे Impact Printer (इम्पैक्ट प्रिंटर) कहते हैं?",
    options: ["प्लॉटर", "लेजर प्रिंटर", "ईकजेट प्रिंटर", "डॉट मैट्रिक्स प्रिंटर"],
    correctOptionIndex: 3,
